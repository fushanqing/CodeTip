...
public class AnnotationFieldMembers implements Creator {
    ...
    @AllArgsConstructor
    @Getter
    public static class AnnotationFieldMember implements SourceCodeRange, JavaSourceNode {
        FieldType fieldType;
        ...
        static class Builder implements MatcherBuilder<AnnotationFieldMembers.AnnotationFieldMember> {
             ...
             */
            @Override
            public Pair<AnnotationFieldMember, String> build(RangeString rangeString, JavaDocs javaDocs, AnnotationUsingMembers annotationUsingMembers, JavaSourceNode fatherNode) {
                boolean normalField;
