...
public class FieldMembers implements Creator {
    ...
    @AllArgsConstructor
    public static class FieldMember implements SourceCodeRange, JavaSourceNode {
        ...
        static class Builder implements MatcherBuilder<FieldMember> {
             ...
             */
            @Override
            public Pair<FieldMember, String> build(RangeString rangeString, JavaDocs javaDocs, AnnotationUsingMembers annotationUsingMembers, JavaSourceNode fatherNode) {
