...
public class EnumFieldMembers implements Creator {
    ...
    public List<? extends JavaSourceNode> getChildNodeMember() {
        return this.enumFieldMemberList;
    }
    ...
    @NoArgsConstructor
    @Setter
    public static class EnumFieldMember implements SourceCodeRange, JavaSourceNode {
        ...
        class Builder implements MatcherBuilder<EnumFieldMembers.EnumFieldMember> {
             ...
             */
            @Override
            public Pair<EnumFieldMembers.EnumFieldMember, String> build(RangeString rangeString, JavaDocs javaDocs, AnnotationUsingMembers annotationUsingMembers, JavaSourceNode fatherNode) {
