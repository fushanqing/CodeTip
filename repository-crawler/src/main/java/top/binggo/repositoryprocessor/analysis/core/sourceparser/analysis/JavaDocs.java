...
public class JavaDocs implements Creator {
    ...
    @AllArgsConstructor
    public static class Comment implements SourceCodeRange, JavaSourceNode {
        ...
        static class Builder implements MatcherBuilder<Comment> {
            ...
            public void init(JavaSourceNode fatherNode, RangeString rangeString, String comments) {
             ...
             */
            @Override
            public Pair<Comment, String> build(RangeString rangeString, JavaDocs javaDocs, AnnotationUsingMembers annotationUsingMembers, JavaSourceNode fatherNode) {
    ...
    @AllArgsConstructor
    public static class JavaDoc implements SourceCodeRange, JavaSourceNode {
        JavaSourceNode fatherNode;
        RangeString rangeString;
        String comments;
        ...
        static class Builder implements MatcherBuilder<JavaDoc> {
             ...
             */
            @Override
            public Pair<JavaDoc, String> build(RangeString rangeString, JavaDocs javaDocs, AnnotationUsingMembers annotationUsingMembers, JavaSourceNode fatherNode) {
                String s = StringUtils.prettyString(rangeString);
