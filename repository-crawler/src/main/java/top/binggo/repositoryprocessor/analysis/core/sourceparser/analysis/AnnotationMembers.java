...
public class AnnotationMembers implements Creator {
    ...
    public static class AnnotationMember implements SourceCodeRange, JavaSourceNode {
        ...
        public List<JavaSourceNode> getChildren() {
            return JavaSourceNode.mergeList(this.annotationFieldMembers.annotationFieldMemberList, this.annotationMembers.annotationMemberList, this.classMembers.classMemberList, this.enumMembers.enumMemberList);
        }
        ...
        class Builder implements MatcherBuilder<AnnotationMembers.AnnotationMember> {
             ...
             */
            @Override
            public Pair<AnnotationMember, String> build(RangeString rangeString, JavaDocs javaDocs, AnnotationUsingMembers annotationUsingMembers, JavaSourceNode fatherNode) {
