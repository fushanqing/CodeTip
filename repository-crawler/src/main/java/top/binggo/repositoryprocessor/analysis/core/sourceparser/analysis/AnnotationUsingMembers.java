...
public class AnnotationUsingMembers implements Creator {
    ...
    private List<AnnotationUsingMember> lastAnnotationUsingMemberList = new ArrayList<>();
    ...
    @AllArgsConstructor
    public static class AnnotationUsingMember implements SourceCodeRange, JavaSourceNode {
        ...
        static class Builder implements MatcherBuilder<AnnotationUsingMember> {
             ...
             */
            @Override
            public Pair<AnnotationUsingMember, String> build(RangeString rangeString, JavaDocs javaDocs, AnnotationUsingMembers annotationUsingMembers, JavaSourceNode fatherNode) {
